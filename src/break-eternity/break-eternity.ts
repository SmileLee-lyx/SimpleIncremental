...
export default class Decimal {
     ...
     *
     * By definition, will never be higher than 1.8e308 in break-eternity.js, since a power tower 1.8e308 numbers tall is the largest representable number.
     *
    ...
    /**
     * Pentation/pentate: The result of tetrating 'height' times in a row. An absurdly strong operator - Decimal.pentate(2, 4.28) and Decimal.pentate(10, 2.37) are already too huge for break-eternity.js!
    ...
    public layeradd10(diff: DecimalSource, linear = false): Decimal {
        ...
        //layeradd10: like adding 'diff' to the number's slog(base) representation. Very similar to tetrate base 10 and iterated log base 10. Also equivalent to adding a fractional amount to the number's layer in its break-eternity.js representation.
        if (diff !== 0) {
    ...
    // If you're here looking to port penta_log to OmegaNum, ExpantaNum, or something similar, then know that this implementation isn't sufficient for that purpose. The pentation functions here run loops without shortcuts, because in break-eternity the numbers don't get large enough to need those shortcuts.
